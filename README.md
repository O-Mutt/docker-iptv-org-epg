# THIS IS AN **UNOFFICIAL** LSIO project

<!-- DO NOT EDIT THIS FILE MANUALLY -->
<!-- Please read https://github.com/o-mutt/docker-iptv-org-epg/blob/master/.github/CONTRIBUTING.md -->
...
# [o-mutt/docker-iptv-org-epg](https://github.com/o-mutt/docker-iptv-org-epg)
...
[![GitHub Stars](https://img.shields.io/github/stars/o-mutt/docker-iptv-org-epg.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/o-mutt/docker-iptv-org-epg)
[![GitHub Release](https://img.shields.io/github/release/o-mutt/docker-iptv-org-epg.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/o-mutt/docker-iptv-org-epg/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/o-mutt/docker-iptv-org-epg/packages)
...
EPG - Electronic Program Guide. Tools for downloading the EPG (Electronic Program Guide) for thousands of TV channels from hundreds of sources.

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://github.com/docker/distribution/blob/master/docs/spec/manifest-v2-2.md#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `o-mutt/docker-iptv-org-epg:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  docker-iptv-org-epg:
    image: o-mutt/docker-iptv-org-epg:latest
    container_name: docker-iptv-org-epg
    cap_add:
      - NET_ADMIN
    environment:
      - PUID=1000
...
docker run -d \
  ...
  --restart unless-stopped \
  o-mutt/docker-iptv-org-epg:latest
```
...
| `-e CRON=*/10 * * * *` | Optionally defined cron timer to run the config.xml update. (default: 23 23 * * *) |
| `-e SITE=*[tv|us|com]` | Optionally define the sites to configure (default **). |
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it docker-iptv-org-epg /bin/bash
    ```

* To monitor the logs of the container in realtime:

    ```bash
    docker logs -f docker-iptv-org-epg
    ```

* Container version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' docker-iptv-org-epg
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' o-mutt/docker-iptv-org-epg:latest
    ```
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull docker-iptv-org-epg
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d docker-iptv-org-epg
        ```
...
* Update the image:
    ...
    ```bash
    docker pull o-mutt/docker-iptv-org-epg:latest
    ```

* Stop the running container:

    ```bash
    docker stop docker-iptv-org-epg
    ```

* Delete the container:

    ```bash
    docker rm docker-iptv-org-epg
    ```
...
```bash
git clone https://github.com/o-mutt/docker-iptv-org-epg.git
cd docker-iptv-org-epg
docker build \
  --no-cache \
  --pull \
  -t o-mutt/docker-iptv-org-epg:latest .
```
